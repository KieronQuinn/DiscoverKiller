...
class OverlayUnsetService: BaseOverlayService() {
    ...
    override fun createOverlayController(): OverlaysController {
        return UnsetOverlayController()
    }

    private inner class UnsetOverlayController: ConfigurationOverlayController(this) {
