...
class SharedPrefsProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY = "com.kieronquinn.app.discoverkiller.provider.sharedprefs"
    ...
    override fun onCreate(): Boolean {
        return try {
            prefs = context.getSharedPreferences(context.packageName + "_prefs", Context.MODE_PRIVATE)
            true
