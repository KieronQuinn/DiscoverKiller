...
import com.kieronquinn.app.discoverkiller.utils.extensions.broadcastReceiverAsFlow
import com.kieronquinn.app.discoverkiller.utils.extensions.contentReceiverAsFlow
import kotlinx.coroutines.flow.*
import kotlinx.coroutines.launch
import java.io.File

abstract class UpdateViewModel: ViewModel() {
...
class UpdateViewModelImpl(
    ...
    context: Context,
    private val updatesRepository: UpdateRepository
): UpdateViewModel() {
    ...
    private val downloadObserver = context.contentReceiverAsFlow(Uri.parse("content://downloads/my_downloads"))
