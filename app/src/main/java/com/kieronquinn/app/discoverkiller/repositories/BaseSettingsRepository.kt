...
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_BOOLEAN
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_COLOR
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_DOUBLE
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_FLOAT
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_INT
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_LONG
import com.kieronquinn.app.discoverkiller.repositories.BaseSettingsRepositoryImpl.SettingsConverters.SHARED_STRING
...
interface BaseSettingsRepository {
    ...
    abstract class DiscoverKillerSetting<T> {
    ...
    /**
     *  Helper implementation of [DiscoverKillerSetting] that takes a regular StateFlow and calls a method
     ...
     */
    class FakeDiscoverKillerSetting<T>(private val flow: StateFlow<T>, private val onSet: (value: T) -> Unit): DiscoverKillerSetting<T>() {
...
abstract class BaseSettingsRepositoryImpl: BaseSettingsRepository {
    ...
    inner class DiscoverKillerSettingImpl<T>(
...
suspend fun DiscoverKillerSetting<Boolean>.invert() {
    set(!get())
}